...
<?php 
	...
	if (isset($_POST['save'])) {
		...
		echo "<script>location='index.php?page=tambahpembelian&cetak=$kodepem';</script>";
	}
...
?>
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading">Pembelian Dan Supplier</div>
			<div class="panel-body">
				<form method="POST">
					<div class="form-group">
...
<script>
	...
	$(document).ready(function(){
		...
		<?php if (isset($_GET['cetak'])): ?>
			bootbox.confirm("Lanjutkan Cetak Nota?", function(result){
				if (result) {
					window.open('nota/cetaknotapembelian.php?kdpembelian=<?php echo $_GET['cetak']; ?>', '_blank');
				}
