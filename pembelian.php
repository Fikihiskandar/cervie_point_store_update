                    ...
                    <table class="table table-striped table-bordered table-hover" id="tabelku">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <?php 
                                        $status = $pembelian->get_approval_status_by_pembelian($data['kd_pembelian']);
                                        if ($status === "Pending") {
                                            echo '<button class="btn btn-warning btn-xs" disabled>Pending</button> ';
                                        } elseif ($status === "Approved") {
                                            echo '<button class="btn btn-success btn-xs" disabled>Approved</button> ';
                                        } else {
                                            echo '<button class="btn btn-default btn-xs" disabled>Unknown</button> ';
                                        }
                                    ?>
